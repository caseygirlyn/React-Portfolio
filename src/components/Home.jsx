    ...
    return <div className="container content my-3 py-1">
        ...
        <section className="row p-3 border-1 mx-4 my-5">
            ...
            <div className="row mx-md-0 m-auto px-md-2 px-0">
                ...
                <p className="col-md-6"><a href="https://pagespeed.web.dev/analysis/https-girlyn-com/ae5jze1jnu?form_factor=desktop" target="_blank" title="PageSpeed Insights"><img src="/images/pagespeed_insights.png" alt="PageSpeed Optimization" className="w-100 h-auto" width={575} height={295}/></a></p>
            </div>
        </section>
